...
urlpatterns = [
    url(r'^article-column/$',views.artcle_column,name='article_column'),
    url(r'^rename-column/$',views.rename_article_column,name='rename_article_column'),
    url(r'^atricle-post/$',views.article_post,name='article_post'),
    ...
    url(r'^list-article-titles/(?P<username>[-\w]+)/$',list_views.article_titles,name='author_artitles'),
]